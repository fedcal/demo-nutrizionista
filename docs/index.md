...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/demo-nutrizionista
...
```bash
git clone https://github.com/fedcal/demo-nutrizionista.git
cd demo-nutrizionista
npm install
npm start
# → http://localhost:4200
```
...
- [GitHub repo](https://github.com/fedcal/demo-nutrizionista)
