...
URL: `https://nutrizionista.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `nutrizionista.demo.federicocalo.dev`
...
- Output directory: `dist/nutrizionista/browser`
...
URL: `https://fedcal.github.io/federico-demo-nutrizionista/`
...
- `base: /federico-demo-nutrizionista/` (subdirectory GH Pages)
- `cleanUrls: true`
...
Per usare `nutrizionista-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   nutrizionista-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `nutrizionista-docs.federicocalo.dev`
